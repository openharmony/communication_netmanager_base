...
HWTEST_F(NotifyCallbackStubTest, OnInterfaceAddressUpdated001, TestSize.Level1)
{
    ...
    ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_INTERFACE_ADDRESS_UPDATED), data, reply, option);
    EXPECT_NE(ret, 0);
    ...
    ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_INTERFACE_ADDRESS_UPDATED), dataOk, reply, option);
    EXPECT_EQ(ret, 0);
}
...
HWTEST_F(NotifyCallbackStubTest, OnInterfaceAddressRemoved001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_INTERFACE_ADDRESS_REMOVED), data, reply, option);
    EXPECT_EQ(ret, 0);
}
...
HWTEST_F(NotifyCallbackStubTest, OnInterfaceAdded001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_INTERFACE_ADDED), data, reply, option);
    EXPECT_EQ(ret, 0);
}
...
HWTEST_F(NotifyCallbackStubTest, OnInterfaceRemoved001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_INTERFACE_REMOVED), data, reply, option);
    EXPECT_EQ(ret, 0);
}
...
HWTEST_F(NotifyCallbackStubTest, OnInterfaceChanged001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_INTERFACE_CHANGED), data, reply, option);
    EXPECT_EQ(ret, 0);
}
...
HWTEST_F(NotifyCallbackStubTest, OnInterfaceLinkStateChanged001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_INTERFACE_LINK_STATE_CHANGED), data, reply, option);
    EXPECT_EQ(ret, 0);
}
...
HWTEST_F(NotifyCallbackStubTest, OnRouteChanged001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_ROUTE_CHANGED), data, reply, option);
    EXPECT_EQ(ret, 0);
}
...
HWTEST_F(NotifyCallbackStubTest, OnDhcpSuccess001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_DHCP_SUCCESS), data, reply, option);
    EXPECT_EQ(ret, 0);
}
...
HWTEST_F(NotifyCallbackStubTest, OnBandwidthReachedLimit001, TestSize.Level1)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t ret = notifyStub_->OnRemoteRequest(static_cast<uint32_t>(NotifyInterfaceCode::ON_BANDWIDTH_REACHED_LIMIT), data, reply, option);
    EXPECT_EQ(ret, 0);
}
} // namespace nmd
} // namespace OHOS