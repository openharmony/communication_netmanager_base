...
HWTEST_F(NetConnServiceTest, UpdateSupplierScore001, TestSize.Level1)
{
    ...
    NetConnService::GetInstance()->MakeDefaultNetWork(NetConnService::GetInstance()->defaultNetSupplier_,
        NetConnService::GetInstance()->netSuppliers_[supplierId]);
    ret = NetConnService::GetInstance()->UpdateSupplierScoreAsync(NetBearType::BEARER_WIFI, TEST_IDENT,
...
HWTEST_F(NetConnServiceTest, CheckIfSettingsDataReadyTest002, TestSize.Level1)
{
...
HWTEST_F(NetConnServiceTest, OnNetSupplierRemoteDiedTest001, TestSize.Level1)
{
    wptr<IRemoteObject> remoteObject = nullptr;
    NetConnService::GetInstance()->netConnEventHandler_ = nullptr;
...
HWTEST_F(NetConnServiceTest, OnNetSupplierRemoteDiedTest002, TestSize.Level1)
{
...
HWTEST_F(NetConnServiceTest, OnNetSupplierRemoteDiedTest003, TestSize.Level1)
{
    wptr<IRemoteObject> remoteObject = new MockNetIRemoteObject();
    EXPECT_NE(remoteObject, nullptr);
    NetConnService::GetInstance()->netConnEventHandler_ = nullptr;
...
HWTEST_F(NetConnServiceTest, RemoveNetSupplierDeathRecipientTest002, TestSize.Level1)
{
...
HWTEST_F(NetConnServiceTest, RequestNetConnectionAsyncTest002, TestSize.Level1)
{
    uint32_t callingUid = 1;
    sptr<NetSpecifier> netSpecifier = new (std::nothrow) NetSpecifier();
    sptr<INetConnCallback> uidCallback = nullptr;
...
HWTEST_F(NetConnServiceTest, UnregisterNetSupplierAsyncTest001, TestSize.Level1)
{
    uint32_t supplierId = 1;
...
HWTEST_F(NetConnServiceTest, UnregisterNetSupplierAsyncTest002, TestSize.Level1)
{
    uint32_t supplierId = 1;
    int32_t callingUid = 1;
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, CheckAndCompareUidTest001, TestSize.Level1)
{
    uint32_t supplierId = 1;
...
HWTEST_F(NetConnServiceTest, HandleScreenEventTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    netConnService->defaultNetSupplier_ = nullptr;
    EXPECT_EQ(netConnService->defaultNetSupplier_, nullptr);
...
HWTEST_F(NetConnServiceTest, UpdateNetCapsAsyncTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::set<NetCap> netCaps;
    uint32_t supplierId = 0;
...
HWTEST_F(NetConnServiceTest, UpdateNetCapsAsyncTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::set<NetCap> netCaps;
    uint32_t supplierId = 1;
...
HWTEST_F(NetConnServiceTest, NetDetectionForDnsHealthSyncTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    int32_t netId = 0;
...
HWTEST_F(NetConnServiceTest, NetDetectionForDnsHealthSyncTest003, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    int32_t netId = 1;
...
HWTEST_F(NetConnServiceTest, RestrictBackgroundChangedAsyncTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, RequestAllNetworkExceptDefaultTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    netConnService->defaultNetSupplier_ = nullptr;
    EXPECT_FALSE(NetConnService::GetInstance()->registerToService_);
...
HWTEST_F(NetConnServiceTest, RequestAllNetworkExceptDefaultTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
...
HWTEST_F(NetConnServiceTest, GenerateNetIdTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, GenerateInternalNetIdTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, NotFindBestSupplierTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
...
HWTEST_F(NetConnServiceTest, NotFindBestSupplierTest003, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
...
HWTEST_F(NetConnServiceTest, HandleCallbackTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, HandleCallbackTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, CallbackForAvailableTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
...
HWTEST_F(NetConnServiceTest, CallbackForAvailableTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
...
HWTEST_F(NetConnServiceTest, MakeDefaultNetWorkTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
...
HWTEST_F(NetConnServiceTest, GetNetSupplierFromListTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, GetNetSupplierFromListTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    netConnService->netSuppliers_[1] = nullptr;
    std::string ident;
...
HWTEST_F(NetConnServiceTest, GetSpecificNetTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, GetSpecificNetTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    netConnService->netSuppliers_[1] = nullptr;
...
HWTEST_F(NetConnServiceTest, GetSpecificNetByIdentTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    NetBearType bearerType = static_cast<NetBearType>(-1);
    std::string ident;
...
HWTEST_F(NetConnServiceTest, GetSpecificNetByIdentTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    netConnService->netSuppliers_[1] = nullptr;
    NetBearType bearerType = BEARER_CELLULAR;
...
HWTEST_F(NetConnServiceTest, GetIfaceNamesTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::list<std::string> ifaceNames;
...
HWTEST_F(NetConnServiceTest, GetNetIdByIdentifierTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::list<int32_t> netIdList;
    netConnService->netSuppliers_[0] = nullptr;
...
HWTEST_F(NetConnServiceTest, GetDumpMessageTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
...
HWTEST_F(NetConnServiceTest, IsValidDecValueTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, SetCurlOptionsTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
    HttpProxy tempProxy;
...
HWTEST_F(NetConnServiceTest, GetHttpUrlFromConfigTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
    std::string httpUrl;
...
HWTEST_F(NetConnServiceTest, SetGlobalHttpProxyOldTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    HttpProxy httpProxy;
...
HWTEST_F(NetConnServiceTest, SetGlobalHttpProxyOldTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    HttpProxy httpProxy;
...
HWTEST_F(NetConnServiceTest, IsValidUserIdTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, GetValidUserIdFromProxyTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
    HttpProxy httpProxy;
...
HWTEST_F(NetConnServiceTest, GetValidUserIdFromProxyTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
    HttpProxy httpProxy;
...
HWTEST_F(NetConnServiceTest, NetDetectionForDnsHealthTest003, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
...
HWTEST_F(NetConnServiceTest, LoadGlobalHttpProxyTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
...
HWTEST_F(NetConnServiceTest, LoadGlobalHttpProxyTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
...
HWTEST_F(NetConnServiceTest, LoadGlobalHttpProxyTest003, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
...
HWTEST_F(NetConnServiceTest, UpdateGlobalHttpProxyTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    HttpProxy httpProxy;
    netConnService->netConnEventHandler_ = std::make_shared<NetConnEventHandler>(netConnService->netConnEventRunner_);
...
HWTEST_F(NetConnServiceTest, OnInterfaceAddressUpdatedTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
...
HWTEST_F(NetConnServiceTest, OnInterfaceAddressRemovedTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    stateCallback.ifaceStateCallbacks_.push_back(nullptr);
...
HWTEST_F(NetConnServiceTest, OnInterfaceAddedTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    stateCallback.ifaceStateCallbacks_.push_back(nullptr);
...
HWTEST_F(NetConnServiceTest, OnInterfaceRemovedTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    stateCallback.ifaceStateCallbacks_.push_back(nullptr);
...
HWTEST_F(NetConnServiceTest, OnInterfaceChangedTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    stateCallback.ifaceStateCallbacks_.push_back(nullptr);
...
HWTEST_F(NetConnServiceTest, OnInterfaceLinkStateChangedTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    stateCallback.ifaceStateCallbacks_.push_back(nullptr);
...
HWTEST_F(NetConnServiceTest, OnRouteChangedTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    stateCallback.ifaceStateCallbacks_.push_back(nullptr);
...
HWTEST_F(NetConnServiceTest, RegisterInterfaceCallbackTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    stateCallback.ifaceStateCallbacks_.push_back(nullptr);
...
HWTEST_F(NetConnServiceTest, RegisterInterfaceCallbackTest002, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    stateCallback.ifaceStateCallbacks_.push_back(nullptr);
...
HWTEST_F(NetConnServiceTest, OnNetIfaceStateRemoteDiedTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    EXPECT_TRUE(stateCallback.ifaceStateCallbacks_.empty());
    wptr<IRemoteObject> remoteObject = nullptr;
...
HWTEST_F(NetConnServiceTest, OnNetIfaceStateRemoteDiedTest002, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
    wptr<IRemoteObject> remoteObject = new MockNetIRemoteObject();
    EXPECT_NE(remoteObject, nullptr);
...
HWTEST_F(NetConnServiceTest, AddIfaceDeathRecipientTest001, TestSize.Level1)
{
    NetConnService::NetInterfaceStateCallback stateCallback;
...
HWTEST_F(NetConnServiceTest, NetUidPolicyChangeTest001, TestSize.Level1)
{
...
HWTEST_F(NetConnServiceTest, NetUidPolicyChangeTest002, TestSize.Level1)
{
...
HWTEST_F(NetConnServiceTest, NetUidPolicyChangeTest003, TestSize.Level1)
{
    NetConnService::NetPolicyCallback policyCallback(NetConnService::GetInstance());
    EXPECT_NE(NetConnService::GetInstance()->defaultNetSupplier_, nullptr);
    NetConnService::GetInstance()->netConnEventHandler_ = nullptr;
...
HWTEST_F(NetConnServiceTest, NetUidPolicyChangeTest004, TestSize.Level1)
{
    NetConnService::NetPolicyCallback policyCallback(NetConnService::GetInstance());
    EXPECT_NE(NetConnService::GetInstance()->defaultNetSupplier_, nullptr);
    NetConnService::GetInstance()->defaultNetSupplier_ = nullptr;
...
HWTEST_F(NetConnServiceTest, SendNetPolicyChangeTest001, TestSize.Level1)
{
    std::weak_ptr<NetConnService> netConnService;
    netConnService.reset();
    NetConnService::NetPolicyCallback policyCallback(netConnService);
...
HWTEST_F(NetConnServiceTest, SendNetPolicyChangeTest002, TestSize.Level1)
{
    NetConnService::NetPolicyCallback policyCallback(NetConnService::GetInstance());
    EXPECT_EQ(NetConnService::GetInstance()->defaultNetSupplier_, nullptr);
    policyCallback.SendNetPolicyChange(1, 1);
...
HWTEST_F(NetConnServiceTest, SendNetPolicyChangeTest003, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
...
HWTEST_F(NetConnServiceTest, OnAddSystemAbilityTest003, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_FALSE(netConnService->registerToService_);
    std::string deviceId = "dev1";
...
HWTEST_F(NetConnServiceTest, OnRemoveSystemAbilityTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string deviceId = "dev1";
...
HWTEST_F(NetConnServiceTest, IsSupplierMatchRequestAndNetworkTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    std::string netSupplierIdent;
    std::set<NetCap> netCaps;
    sptr<NetSupplier> supplier = new NetSupplier(BEARER_CELLULAR, netSupplierIdent, netCaps);
    // EXPECT_TRUE(netConnService->netActivates_.empty());
    netConnService->netActivates_[0] = nullptr;
    // EXPECT_EQ(netConnService->netActivates_.size(), 1);
    bool ret = netConnService->IsSupplierMatchRequestAndNetwork(supplier);
    EXPECT_FALSE(ret);
}

HWTEST_F(NetConnServiceTest, IsSupplierMatchRequestAndNetworkTest003, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
...
HWTEST_F(NetConnServiceTest, RecoverNetSysTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_NE(netConnService->defaultNetSupplier_, nullptr);
    netConnService->netSuppliers_[0] = nullptr;
...
HWTEST_F(NetConnServiceTest, RecoverNetSysTest002, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_EQ(netConnService->defaultNetSupplier_, nullptr);
    netConnService->netSuppliers_[1] = nullptr;
...
HWTEST_F(NetConnServiceTest, RegisterSlotTypeTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    netConnService->netConnEventHandler_ = nullptr;
    uint32_t supplierId = 10;
...
HWTEST_F(NetConnServiceTest, OnNetSysRestartTest001, TestSize.Level1)
{
    auto netConnService = NetConnService::GetInstance();
    EXPECT_EQ(netConnService->netConnEventHandler_, nullptr);
