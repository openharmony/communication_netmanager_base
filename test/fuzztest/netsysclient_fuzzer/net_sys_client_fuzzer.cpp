...
void NetworkCreatePhysicalFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_NETWORK_CREATE_PHYSICAL), dataParcel);
}
...
void NetworkRemoveInterfaceFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteInt32(netId);
    dataParcel.WriteString(iface);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_NETWORK_REMOVE_INTERFACE), dataParcel);
}
...
void RegisterNotifyCallbackFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_REGISTER_NOTIFY_CALLBACK), dataParcel);
}
...
void UnRegisterNotifyCallbackFuzzTest(const uint8_t *data, size_t size)
{
    ...
    notifyCb->Marshalling(dataParcel);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_UNREGISTER_NOTIFY_CALLBACK), dataParcel);
}
...
void NetworkAddRouteParcelFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_NETWORK_ADD_ROUTE_PARCEL), dataParcel);
}
...
void IpfwdAddInterfaceForwardFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_IPFWD_ADD_INTERFACE_FORWARD), dataParcel);
}
...
void IpfwdRemoveInterfaceForwardFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteString(fromIface);
    dataParcel.WriteString(toIface);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_IPFWD_REMOVE_INTERFACE_FORWARD), dataParcel);
}
...
void InterfaceSetIpAddressFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_INTERFACE_SET_IP_ADDRESS), dataParcel);
}
...
void FirewallSetUidsDeniedListChainFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteString(ifaceName);
    dataParcel.WriteString(ipAddress);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_FIREWALL_SET_UID_DENIED_LIST_CHAIN), dataParcel);
}
...
void SetInternetPermissionFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_SET_INTERNET_PERMISSION), dataParcel);
}
...
void GetFwmarkForNetworkFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_GET_FWMARK_FOR_NETWORK), dataParcel);
}
...
void BandwidthEnableDataSaverFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_BANDWIDTH_ENABLE_DATA_SAVER), dataParcel);
}
...
void BandwidthSetIfaceQuotaFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteString(ifName);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_BANDWIDTH_SET_IFACE_QUOTA), dataParcel);
}
...
void BandwidthRemoveIfaceQuotaFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteString(ifName);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_BANDWIDTH_REMOVE_IFACE_QUOTA), dataParcel);
}
...
void BandwidthAddDeniedListFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteInt32(uid);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_BANDWIDTH_ADD_DENIED_LIST), dataParcel);
}
...
void BandwidthRemoveDeniedListFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteInt32(uid);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_BANDWIDTH_REMOVE_DENIED_LIST), dataParcel);
}
...
void BandwidthAddAllowedListFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteInt32(uid);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_BANDWIDTH_ADD_ALLOWED_LIST), dataParcel);
}
...
void BandwidthRemoveAllowedListFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteInt32(uid);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_BANDWIDTH_REMOVE_ALLOWED_LIST), dataParcel);
}
...
void GetNetworkSharingTrafficFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_GET_SHARING_NETWORK_TRAFFIC), dataParcel);
}
...
void StartDnsProxyListenFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_START_DNS_PROXY_LISTEN), dataParcel);
}
...
void SetIptablesCommandForResFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_SET_IPTABLES_CMD_FOR_RES), dataParcel);
}
...
void NetworkCreateVirtualFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NetsysInterfaceCode::NETSYS_NETWORK_CREATE_VIRTUAL), dataParcel);
}
...
void OnInterfaceAddedFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NotifyInterfaceCode::ON_INTERFACE_ADDED), dataParcel);
}
...
void OnInterfaceRemovedFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NotifyInterfaceCode::ON_INTERFACE_REMOVED), dataParcel);
}
...
void OnInterfaceChangedFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NotifyInterfaceCode::ON_INTERFACE_CHANGED), dataParcel);
}
...
void OnInterfaceLinkStateChangedFuzzTest(const uint8_t *data, size_t size)
{
    ...
    dataParcel.WriteString(ifName);
    dataParcel.WriteBool(up);
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NotifyInterfaceCode::ON_INTERFACE_LINK_STATE_CHANGED), dataParcel);
}
...
void OnRouteChangedFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NotifyInterfaceCode::ON_ROUTE_CHANGED), dataParcel);
}
...
void OnDhcpSuccessFuzzTest(const uint8_t *data, size_t size)
{
    ...
    OnRemoteRequest(static_cast<uint32_t>(NetsysNative::NotifyInterfaceCode::ON_DHCP_SUCCESS), dataParcel);
}
