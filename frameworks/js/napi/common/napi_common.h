...
public:
    ...
    static void GetPropertyString(
        napi_env env, napi_value object, const std::string &propertyName, std::string &property);
    static void GetPropertyInt32(
        napi_env env, napi_value object, const std::string &propertyName, int32_t &property);
    static void GetPropertyInt64(
        napi_env env, napi_value object, const std::string &propertyName, int64_t &property);
    static std::string GetNapiStringValue(
    ...
    static int32_t GetNapiInt32Value(
        napi_env env, napi_value napiValue, const std::string &name, const int32_t &defValue = 0);
    static int64_t GetNapiInt64Value(
        napi_env env, napi_value napiValue, const std::string &name, const int64_t &defValue = 0);
