...
{
    memberFuncMap_[static_cast<uint32_t>(PolicyCallbackInterfaceCode::NOTIFY_NET_UID_POLICY_CHANGE)] = &NetPolicyCallbackStub::OnNetUidPolicyChange;
    memberFuncMap_[static_cast<uint32_t>(PolicyCallbackInterfaceCode::NOTIFY_NET_UID_RULE_CHANGE)] = &NetPolicyCallbackStub::OnNetUidRuleChange;
    memberFuncMap_[static_cast<uint32_t>(PolicyCallbackInterfaceCode::NOTIFY_NET_QUOTA_POLICY_CHANGE)] = &NetPolicyCallbackStub::OnNetQuotaPolicyChange;
    memberFuncMap_[static_cast<uint32_t>(PolicyCallbackInterfaceCode::NOTIFY_NET_METERED_IFACES_CHANGE)] = &NetPolicyCallbackStub::OnNetMeteredIfacesChange;
    memberFuncMap_[static_cast<uint32_t>(PolicyCallbackInterfaceCode::NOTIFY_BACKGROUND_POLICY_CHANGE)] = &NetPolicyCallbackStub::OnNetBackgroundPolicyChange;
}
