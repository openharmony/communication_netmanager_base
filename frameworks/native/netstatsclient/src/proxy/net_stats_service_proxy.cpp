...
int32_t NetStatsServiceProxy::RegisterNetStatsCallback(const sptr<INetStatsCallback> &callback)
{
    ...
    int32_t retCode = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_NSM_REGISTER_NET_STATS_CALLBACK), dataParcel, replyParcel, option);
    if (retCode != 0) {
        return retCode;
    }
...
int32_t NetStatsServiceProxy::UnregisterNetStatsCallback(const sptr<INetStatsCallback> &callback)
{
    ...
    MessageOption option;
    MessageParcel replyParcel;
    int32_t retCode = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_NSM_UNREGISTER_NET_STATS_CALLBACK), dataParcel, replyParcel, option);
    if (retCode != 0) {
        return retCode;
    }
    return replyParcel.ReadInt32();
...
int32_t NetStatsServiceProxy::GetIfaceRxBytes(uint64_t &stats, const std::string &interfaceName)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t error = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_IFACE_RXBYTES), data, reply, option);
    if (error != 0) {
...
int32_t NetStatsServiceProxy::GetIfaceTxBytes(uint64_t &stats, const std::string &interfaceName)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t error = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_IFACE_TXBYTES), data, reply, option);
    if (error != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", error);
        return error;
    }
...
int32_t NetStatsServiceProxy::GetCellularRxBytes(uint64_t &stats)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t error = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_CELLULAR_RXBYTES), data, reply, option);
    if (error != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", error);
        return error;
    }
...
int32_t NetStatsServiceProxy::GetCellularTxBytes(uint64_t &stats)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t error = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_CELLULAR_TXBYTES), data, reply, option);
    if (error != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", error);
        return error;
    }
...
int32_t NetStatsServiceProxy::GetAllRxBytes(uint64_t &stats)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t error = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_ALL_RXBYTES), data, reply, option);
    if (error != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", error);
        return error;
    }
...
int32_t NetStatsServiceProxy::GetAllTxBytes(uint64_t &stats)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t error = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_ALL_TXBYTES), data, reply, option);
    if (error != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", error);
        return error;
    }
...
int32_t NetStatsServiceProxy::GetUidRxBytes(uint64_t &stats, uint32_t uid)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t error = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_UID_RXBYTES), data, reply, option);
    if (error != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", error);
        return error;
    }
...
int32_t NetStatsServiceProxy::GetUidTxBytes(uint64_t &stats, uint32_t uid)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t error = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_UID_TXBYTES), data, reply, option);
    if (error != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", error);
        return error;
    }
                                                  ...
                                                  NetStatsInfo &statsInfo)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t sendResult = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_IFACE_STATS_DETAIL), data, reply, option);
    if (sendResult != 0) {
                                                ...
                                                NetStatsInfo &statsInfo)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t sendResult = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_UID_STATS_DETAIL), data, reply, option);
    if (sendResult != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", sendResult);
        return sendResult;
    }
                                                ...
                                                const NetStatsInfo &stats)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t sendResult = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_UPDATE_IFACES_STATS), data, reply, option);
    if (sendResult != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", sendResult);
        return sendResult;
    }
...
int32_t NetStatsServiceProxy::UpdateStatsData()
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t sendResult = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_UPDATE_STATS_DATA), data, reply, option);
    if (sendResult != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", sendResult);
        return sendResult;
    }
...
int32_t NetStatsServiceProxy::ResetFactory()
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t sendResult = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_NSM_RESET_FACTORY), data, reply, option);
    if (sendResult != 0) {
        NETMGR_LOG_E("proxy SendRequest failed, error code: [%{public}d]", sendResult);
        return sendResult;
    }
...
int32_t NetStatsServiceProxy::GetAllStatsInfo(std::vector<NetStatsInfo> &infos)
{
    ...
    MessageParcel reply;
    MessageOption option;
    int32_t result = remote->SendRequest(static_cast<uint32_t>(StatsInterfaceCode::CMD_GET_ALL_STATS_INFO), data, reply, option);
    if (result != ERR_NONE) {
