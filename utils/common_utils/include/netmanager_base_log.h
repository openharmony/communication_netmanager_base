...
#define NETMANAGER_LOG(Level, fmt, ...)    (void)HILOG_IMPL(LOG_CORE, LOG_##Level, LOG_DOMAIN, LOG_TAG, fmt, ##__VA_ARGS__)
...
#define NETMANAGER_LOG_FUNC(Level, fmt, ...)                                         \
    do {                                                                        \
        (void)HILOG_IMPL(LOG_CORE, LOG_##Level, LOG_DOMAIN, LOG_TAG, "[%{public}s]" fmt,     \
