...
std::map<int32_t, const char *> g_errStringMap = {
    ...
    {NETMANAGER_WEARABLE_DISTRIBUTED_NET_SERVICE_ERR_INVALID_RULE_TYPE, "The rule type is invalid"},
    {NETMANAGER_WEARABLE_DISTRIBUTED_NET_SERVICE_ERR_INVALID_SUPPLIER_ID, "The supplier id is invalid"},
    {NETMANAGER_WEARABLE_DISTRIBUTED_NET_SERVICE_ERR_OBJ_ERR_NULL, "The obj is null"},
#endif
