...
#ifndef I_NET_DNS_HEALTH_CALLBACK_H
#define I_NET_DNS_HEALTH_CALLBACK_H
...
public:
    DECLARE_INTERFACE_DESCRIPTOR(u"OHOS.NetsysNative.INetDnsHealthCallback");
    enum {
...
#endif // I_NET_DNS_HEALTH_CALLBACK_H
