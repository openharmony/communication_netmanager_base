...
enum {
    ...
    NETWORKVPN_ERROR_DESTROY_VPN = 2203002,
    NETWORKVPN_ERROR_CREATE_INTERFACE = 2203003,
    NETWORKVPN_ERROR_ENABLE_INTERFACE = 2203004,
    NETWORKVPN_ERROR_UNKNOWN_TYPE = 2203005,
};
