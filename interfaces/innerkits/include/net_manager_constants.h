...
enum {
    ...
    NETMANAGER_SUCCESS = 2100000,
    NETMANAGER_ERR_INVALID_PARAMETER = 2100001,
    NETMANAGER_ERR_OPERATION_FAILED = 2100002,
    NETMANAGER_ERR_INTERNAL = 2100003,
    NETMANAGER_ERR_IPC = 2100004,
    NETMANAGER_ERR_REGISTER_CALLBACK_FAIL = 2100005,
    NETMANAGER_ERR_UNINIT = 2100006,
...
enum {
    ...
    NETMANAGER_EXT_SUCCESS = 2200000,
    ...
    NETMANAGER_EXT_ERR_IPC = 2200004,
    NETMANAGER_EXT_ERR_REGISTER_CALLBACK_FAIL = 2200005,
    NETMANAGER_EXT_ERR_UNINIT = 2200006,
...
enum {
    ...
    NETWORKSHARE_ERROR_SHARING_IFACE_ERROR = 2202007,
