...
enum {
    NETMANAGER_BTPROXY_ERR_START_FAIL = 2205001,
    NETMANAGER_BTPROXY_ERR_STOP_FAIL = 2205002,
    NETMANAGER_BTPROXY_ERR_INIT_FAIL = 2205003,
    NETMANAGER_BTPROXY_ERR_INVALID_PORT_ID = 2205004,
    NETMANAGER_BTPROXY_ERR_INVALID_UDP_ID = 2205005,
    NETMANAGER_BTPROXY_ERR_INVALID_TCP_ID = 2205006,
    NETMANAGER_BTPROXY_ERR_INVALID_RULE_TYPE = 2205007,
    NETMANAGER_BTPROXY_ERR_INVALID_SUPPLIER_ID = 2205008,
    NETMANAGER_BTPROXY_ERR_OBJ_ERR_NULL = 2205009,
};
