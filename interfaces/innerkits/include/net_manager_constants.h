...
enum {
    ...
    NETMANAGER_WEARABLE_DISTRIBUTED_NET_ERR_INVALID_UDP_ID = 2205005,
    NETMANAGER_WEARABLE_DISTRIBUTED_NET_ERR_INVALID_TCP_ID = 2205006,
    ...
    NETMANAGER_WEARABLE_DISTRIBUTED_NET_ERR_OBJ_ERR_NULL = 2205009,
    NETMANAGER_WEARABLE_DISTRIBUTED_NET_ERR_IPTABLES_COMMAND_FAILED = 2205010,
};
#endif
