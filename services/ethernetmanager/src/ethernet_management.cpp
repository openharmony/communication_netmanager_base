...
EthernetManagement::NativeNotifyCallback::NativeNotifyCallback(EthernetManagement &ethernetManagement)
    : ethernetManagement_(ethernetManagement)
{
}

EthernetManagement::NativeNotifyCallback::~NativeNotifyCallback()
{
}

int32_t EthernetManagement::NativeNotifyCallback::OnInterfaceAddressUpdated(const std::string &, const std::string &,
    int, int)
{
    return 0;
}

int32_t EthernetManagement::NativeNotifyCallback::OnInterfaceAddressRemoved(const std::string &, const std::string &,
    int, int)
{
    return 0;
}

int32_t EthernetManagement::NativeNotifyCallback::OnInterfaceAdded(const std::string &)
{
    return 0;
}

int32_t EthernetManagement::NativeNotifyCallback::OnInterfaceRemoved(const std::string &)
{
    return 0;
}

int32_t EthernetManagement::NativeNotifyCallback::OnInterfaceChanged(const std::string &, bool)
{
    return 0;
}

int32_t EthernetManagement::NativeNotifyCallback::OnInterfaceLinkStateChanged(const std::string &, bool)
{
    return 0;
}

int32_t EthernetManagement::NativeNotifyCallback::OnRouteChanged(bool, const std::string &, const std::string &,
    const std::string &)
{
    return 0;
}

int32_t EthernetManagement::NativeNotifyCallback::OnDhcpSuccess(sptr<OHOS::NetdNative::DhcpResultParcel> &dhcpResult)
{
...
EthernetManagement::EthernetManagement()
{
    ...
    netdNativeService_ = GetNetdNativeProxy();
...
int32_t EthernetManagement::UpdateDevInterfaceLinkInfo(sptr<OHOS::NetdNative::DhcpResultParcel> &dhcpResult)
{
...
void EthernetManagement::Init()
{
    ...
    NETMGR_LOG_D("EthernetManagement devs size[%{public}d]", static_cast<int32_t>(linkInfos.size()));
    ...
    NETMGR_LOG_D("EthernetManagement ReadFileList size[%{public}d]", static_cast<int32_t>(devCfgs.size()));
    ...
    NETMGR_LOG_D("EthernetManagement devs_ size[%{public}d", static_cast<int32_t>(devs_.size()));
}
    ...
    std::string &fileContent)
{
    ...
    if (cfg->mode_ == STATIC) {
        ...
        if (cfg->ipStatic_.netMask_.address_.empty()) {
            fileContent = fileContent + "NETMASK=" + cfg->ipStatic_.ipAddr_.address_ + "\n";
        } else {
...
void EthernetManagement::StartDhcpClient(const std::string &dev, sptr<DevInterfaceState> &devState)
{
    if (netdNativeService_ != nullptr) {
        ...
        netdNativeService_->StartDhcpClient(dev, false);
...
void EthernetManagement::StopDhcpClient(const std::string &dev, sptr<DevInterfaceState> &devState)
{
    if (netdNativeService_ != nullptr) {
        ...
        netdNativeService_->StopDhcpClient(dev, false);
...
sptr<OHOS::NetdNative::INetdService> EthernetManagement::GetNetdNativeProxy()
{
