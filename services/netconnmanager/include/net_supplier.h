...
public:
    ...
    bool SupplierConnection(const std::set<NetCap> &netCaps, const NetRequestBySpecifier netrequestBySpecifier = {});
    ...
    bool RequestToConnect(uint32_t reqId, const NetRequestBySpecifier netrequestBySpecifier = {});
