...
void Network::UpdateIpAddrs(const NetLinkInfo &newNetLinkInfo)
{
    ...
    NETMGR_LOG_I("UpdateIpAddrs, old ip addrs size: [%{public}d]",
        static_cast<int>(netLinkInfo_.netAddrList_.size()));
    for (const auto &inetAddr : netLinkInfo_.netAddrList_) {
    ...
    NETMGR_LOG_I("UpdateIpAddrs, new ip addrs size: [%{public}d]",
        static_cast<int>(newNetLinkInfo.netAddrList_.size()));
