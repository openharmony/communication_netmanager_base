...
static const uint32_t IPV4_HEADERS_LENGTH = 134; // transfer header:20 + 40, ip header:20 + 40, link header:14
static const uint32_t IPV6_HEADERS_LENGTH = 154; // transfer header:20 + 40, ip header:40 + 40, link header:14
enum { IFNAME_SIZE = 32 };
