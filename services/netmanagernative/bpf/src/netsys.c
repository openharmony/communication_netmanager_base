...
SEC("cgroup_addr/recvmsg4")
static int inet_check_recvmsg4(struct bpf_sock_addr *ctx)
{
    void *map_ptr = &app_uid_access_policy_map;
...
SEC("cgroup_addr/recvmsg6")
static int inet_check_recvmsg6(struct bpf_sock_addr *ctx)
{
    void *map_ptr = &app_uid_access_policy_map;
