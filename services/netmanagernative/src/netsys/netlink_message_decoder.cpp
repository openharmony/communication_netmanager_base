...
void NetlinkMessageDecoder::AddParam(const char *addrstr,
...
bool NetlinkMessageDecoder::ProcessIFAddress(ifaddrmsg *ifaddr,
                                             char *addrstr,
                                             socklen_t len,
                                             const char *msgtype,
                                             char *ifname,
...
bool NetlinkMessageDecoder::ParseNfPacketMessage(nlmsghdr *nh)
{
    ...
    strcpy_s(hex, strlen(HEX_PREFIX), "HEX=");
...
bool NetlinkMessageDecoder::AddRtParam(char *dst,
                                       size_t dstLen,
                                       const char *gw,
                                       const char *dev,
