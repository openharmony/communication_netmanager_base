...
public:
    ...
    bool Decode(char *buffer, int32_t size, int32_t format = NetlinkDefine::NETLINK_FORMAT_ASCII);
...
private:
    ...
    bool AddRtParam(char *dst, size_t dstLen, const char *gw, const char *dev, int32_t prefixLength, int32_t family);
};
} // namespace nmd
} // namespace OHOS
