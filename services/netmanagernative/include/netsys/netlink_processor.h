...
public:
    NetlinkProcessor(std::shared_ptr<std::vector<sptr<NetsysNative::INotifyCallback>>> callback, int32_t listenerSocket,
                     int32_t format);
...
private:
    ...
    void OnInterfaceDnsServersUpdate(const std::string &ifName, int64_t lifetime,
