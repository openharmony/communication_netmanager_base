...
public:
    static const int32_t NFLOG_QUOTA_GROUP = 1;
    static const int32_t NETFILTER_STRICT_GROUP = 2;
    static const int32_t NFLOG_WAKEUP_GROUP = 3;
    static const int32_t UEVENT_GROUP = 0xffffffff;
    ...
    void RegisterNetlinkCallback(sptr<NetsysNative::INotifyCallback> callback);
...
private:
    ...
    std::unique_ptr<NetlinkProcessor> SetSocket(int32_t &sock,
                                                int32_t netlinkType,
                                                int32_t groups,
                                                int32_t format,
                                                bool configNflog);
