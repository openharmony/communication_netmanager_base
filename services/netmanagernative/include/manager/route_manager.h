...
public:
    ...
    /**
     * @brief The interface is add route table
     *
    ...
    /**
     * @brief The interface is remove route table
     *
     * @param tableType Route table type.Must be one of INTERFACE/VPN_NETWORK/LOCAL_NETWORK.
     * @param interfaceName Output network device name of the route item
     * @param destinationName Destination address of route item
    ...
    /**
     * @brief The interface is update route table
     *
     * @param tableType Route table type.Must be one of INTERFACE/VPN_NETWORK/LOCAL_NETWORK.
     * @param interfaceName Output network device name of the route item
     * @param destinationName Destination address of route item
    ...
    /**
     * @brief Add interface to default network
     *
     * @param interfaceName Output network device name of the route item
    ...
    /**
     * @brief Remove interface from default network
     *
     * @param interfaceName Output network device name of the route item
     * @param permission Network permission. Must be one of
     *        PERMISSION_NONE/PERMISSION_NETWORK/PERMISSION_SYSTEM.
    ...
    /**
     * @brief Add interface to physical network
     *
    ...
    /**
     * @brief Remove interface from physical network
     *
     * @param netId Network number
     * @param interfaceName Output network device name of the route item
     * @param permission Network permission. Must be one of
    ...
    /**
     * @brief Modify physical network permission
     *
     * @param netId Network number
     * @param interfaceName Output network device name of the route item
    ...
    /**
     * @brief Add interface to local network
     *
     * @param netId Network number
     * @param interfaceName Output network device name of the route item
    ...
    /**
     * @brief Remove interface from local network
     *
     * @param netId Network number
     * @param interfaceName Output network device name of the route item
    ...
    /**
     * @brief Parse destination address
     *
