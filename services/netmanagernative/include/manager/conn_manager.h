...
public:
    ...
    /**
     * @brief Creates a physical network
     *
    ...
    /**
     * @brief Destroy a network. Any interfaces added to the network are removed, and the network ceases
    ...
    /**
     * @brief Set network as default network
     *
    ...
    /**
     * @brief Add an interface to a network. The interface must not be assigned to any network, including
    ...
    /**
     * @brief Remove an interface to a network. The interface must be assigned to the specified network
     *
     * @param netId The network to add the interface
    ...
    /**
     * @brief Add a route for specific network
     *
    ...
    /**
     * @brief Remove a route for specific network
     *
    ...
    /**
     * @brief Update a route for specific network
     *
    ...
    /**
     * @brief Get the mark for the given network id
     *
    ...
    /**
     * @brief Set the permission required to access a specific network
     *
